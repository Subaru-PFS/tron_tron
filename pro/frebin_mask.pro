...
; NAME: frebin_mask
;
; PURPOSE: Read an unbinned mask file and write a binned mask file.
;
;
; CALLING SEQUENCE:
;
...
;                        if necessary. 
;    newSize           - a two-element array indicating the array size that we want.
;
; NOTES:
...
; EXAMPLE:
;
; frebin_mask, 'na2.fits', 'na2-3x3.fits', [3x3]
;
; MODIFICATION HISTORY:
;
;-

pro frebin_mask,infileName,outfileName,binFactor
  ...
  binnedSize = fullSize / binFactor
  trimSize = binnedSize * binFactor
